...
image = Image.new("RGB", background_image.size, "white")

image.paste(background_image, (0, 0))

draw = ImageDraw.Draw(image)
draw.line(first_points, fill="black", width=10)
draw.line(second_points, fill="black", width=10)

draw.polygon(first_points, fill="white")  # Fill with green color
draw.polygon(second_points, fill="white")  # Fill with yellow color

red_dot_coordinates = [(150, 150), (120, 150)]  # Example coordinates
for coords in red_dot_coordinates:
    draw.ellipse((coords[0]-5, coords[1]-5, coords[0]+5, coords[1]+5), fill="red")

image.save("connected_lines.png")
